      ...
      <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-4">
          <div className="lg:col-span-2">
            <span className="inline-flex items-center justify-center rounded-md bg-white px-3 py-2 shadow-md-card">
              <Image
                src="/logo-md.jpg"
            ...
            <p className="mt-6 max-w-md text-sm text-md-paper/70">
            ...
            <div className="mt-8 space-y-3 text-sm text-md-paper/80">
              <div className="flex items-start gap-3">
                <MapPin className="mt-0.5 h-4 w-4 flex-shrink-0 text-md-cyan" strokeWidth={1.5} />
                <span>{contact.address}</span>
              </div>
              <a
                href={`tel:+${contact.whatsappNumber}`}
                className="flex items-center gap-3 transition hover:text-md-cyan-soft"
              >
                <Phone className="h-4 w-4 flex-shrink-0 text-md-cyan" strokeWidth={1.5} />
              ...
              <a
                ...
                className="flex items-center gap-3 transition hover:text-md-cyan-soft"
              >
                <Mail className="h-4 w-4 flex-shrink-0 text-md-cyan" strokeWidth={1.5} />
              ...
              <a
                ...
                className="flex items-center gap-3 transition hover:text-md-cyan-soft"
              >
                <Instagram className="h-4 w-4 flex-shrink-0 text-md-cyan" strokeWidth={1.5} />
          ...
          <div>
            <h4 className="font-display text-base font-medium text-md-cyan">
              Serviços
            </h4>
        ...
        <div className="mt-16 border-t border-md-paper/10 pt-8">
          <div className="space-y-4 text-xs text-md-paper/50">
            ...
            <p>
              ...
              <Link href="/politica-de-privacidade" className="underline transition hover:text-md-cyan-soft">
                Política de Privacidade
              </Link>.
            </p>
            <p className="pt-4">
              © {new Date().getFullYear()} MD Assessoria &amp; Consultoria Empresarial.

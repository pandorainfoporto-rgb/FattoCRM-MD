...
2. **Endereço físico + CNPJ** (rodapé, contratos, compliance)
3. **Número OAB do Dr. Marcelo** (ex.: `OAB/RS XXXXX`) — nome já recebido
4. **Foto profissional do Dr. Marcelo** (LP institucional + autoridade)
